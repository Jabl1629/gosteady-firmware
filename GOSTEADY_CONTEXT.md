...
| `GS0000000001` | `0.13.1-pilot` (flashed 2026-05-31, coord §C39; client_id=GS0000000001, cert sec_tag 201) | Working (external J-Link) | iBasis eSIM (fresh) | **First shipping unit — staged for the first D2C QR-claim test** (d2c-phase1 §7). Cloud: `ready_to_provision`, owner NULL, `activated_at` None (real activate flow will run); walkerId `37b2e250-…` + QR live; public lookup `unclaimed`. Heartbeating in pre-activation. Blocked on Twilio OTP + Jace phone-side claim. |
