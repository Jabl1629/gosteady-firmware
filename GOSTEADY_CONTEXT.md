...
- **Coord doc (append-only joint log):** `~/Documents/gosteady-portal/docs/firmware-coordination/2026-04-17-cloud-contracts.md` _(moved out of iCloud 2026-05-23 to fix tsc/npm slowness; iCloud copy at the old path may persist for a short confidence-window before deletion)_
  ...
  - **Latest entry: §C29 (2026-05-26)** — 2B-FAC-R PollingController landed in portal: new `lib/state/polling_controller.dart` (WidgetsBindingObserver-backed; 60 s Census + 30 s Patient Detail; foreground-only). Live-validated against `pt_bench_98` via Chrome-MCP network capture — both poll cadences fire as designed; lifecycle pause kicks in on tab background. **Zero firmware-facing impact** — pure-Flutter follow-up. Prior §C28.5 same day (2026-05-26) covered the CR-1 heartbeat-processor lastSeen-mirror deploy + live validation. Prior milestones: §C27 (2026-05-24) three cloud deploys — 2A-0 amendment + 2A-UM-P + 1C-slim; §C24 (2026-05-18) connection-coordinator Lambda live; §C26 (2026-05-23) Phase 2A-AA alert actions deployed
