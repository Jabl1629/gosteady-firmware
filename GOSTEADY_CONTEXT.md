...
- **Coord doc (append-only joint log):** `~/Library/Mobile Documents/com~apple~CloudDocs/Documents/GoSteady/gosteady-portal/docs/firmware-coordination/2026-04-17-cloud-contracts.md`
  ...
  - **Latest entry: §C24 (2026-05-18)** — connection-coordinator Lambda live in dev; §C22 Finding 2 (AWS IoT 1h persistent_session) closed end-to-end via cloud-side coordinator that fires on AWS IoT lifecycle events
